// ═══════════════════════════════════════
// MeshChat v1.2.4 — ActionLog Node
// ═══════════════════════════════════════
class Node {
  constructor() {
  ...
  // ═══ BOOTSTRAP + WEBRTC ═══
  _setStatus(s) { this._status = s; const t = document.getElementById('statusTag'); if (!t) return; t.textContent = 'v1.2.4'; t.className = s === 'connected' ? 'tag tag-on' : s === 'reconnecting' ? 'tag tag-warn' : 'tag tag-off'; }
  startWakeDetection() {
